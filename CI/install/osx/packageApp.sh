...
/usr/local/Cellar/qt/5.15.1/bin/macdeployqt ./OBS.app
...
install_name_tool -change /usr/local/Cellar/qt/5.15.1/lib/QtCore.framework/Versions/5/QtCore @executable_path/../Frameworks/QtCore.framework/Versions/5/QtCore ./OBS.app/Contents/Frameworks/QtNetwork.framework/Versions/5/QtNetwork
