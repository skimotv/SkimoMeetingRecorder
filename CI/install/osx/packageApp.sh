...
cp ../CI/install/osx/skimo.icns ./Skimo.app/Contents/Resources
cp -R rundir/RelWithDebInfo/obs-plugins/ ./Skimo.app/Contents/PlugIns
cp ../CI/install/osx/Info.plist ./Skimo.app/Contents

../CI/install/osx/dylibBundler -b -cd -d ./Skimo.app/Contents/Frameworks -p @executable_path/../Frameworks/ \
...
/usr/local/Cellar/qt/5.15.1/bin/macdeployqt ./Skimo.app
...
install_name_tool -change /usr/local/Cellar/qt/5.15.1/lib/QtCore.framework/Versions/5/QtCore @executable_path/../Frameworks/QtCore.framework/Versions/5/QtCore ./Skimo.app/Contents/Frameworks/QtNetwork.framework/Versions/5/QtNetwork
